...
#ifndef THIRD_PARTY_TINK_TESTING_CC_SERIVCES_KEYSET_IMPL_H_
#define THIRD_PARTY_TINK_TESTING_CC_SERIVCES_KEYSET_IMPL_H_
...
#endif  // THIRD_PARTY_TINK_TESTING_CC_SERIVCES_KEYSET_IMPL_H_
