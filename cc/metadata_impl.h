...
#ifndef THIRD_PARTY_TINK_TESTING_CC_METADATA_IMPL_H_
#define THIRD_PARTY_TINK_TESTING_CC_METADATA_IMPL_H_
...
#endif  // THIRD_PARTY_TINK_TESTING_CC_METADATA_IMPL_H_
