...
_PRIVATE_TYPE_URL = 'type.googleapis.com/google.crypto.tink.JwtRsaSsaPssPrivateKey'
_PUBLIC_TYPE_URL = 'type.googleapis.com/google.crypto.tink.JwtRsaSsaPssPublicKey'
...
def _basic_2048bit_key() -> jwt_rsa_ssa_pss_pb2.JwtRsaSsaPssPrivateKey:
  """Key from https://www.rfc-editor.org/rfc/rfc7517#appendix-C."""

  key = jwt_rsa_ssa_pss_pb2.JwtRsaSsaPssPrivateKey(
      version=0,
      public_key=jwt_rsa_ssa_pss_pb2.JwtRsaSsaPssPublicKey(
          version=0,
          algorithm=jwt_rsa_ssa_pss_pb2.JwtRsaSsaPssAlgorithm.PS256,
          n=_base64_decode("""
...
def _proto_keys() -> (
    Iterator[Tuple[str, bool, jwt_rsa_ssa_pss_pb2.JwtRsaSsaPssPrivateKey]]
):
  """Returns triples (name, validity, proto) for JwtRsaSsaPssPrivateKey."""
...
def jwt_rsa_ssa_pss_public_keys() -> Iterator[test_key.TestKey]:
  """Returns public test keys for JwtRsaSsaPssPublicKey."""
