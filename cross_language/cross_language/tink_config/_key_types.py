...
SUPPORTED_LANGUAGES = {
    ...
    'SlhDsaPrivateKey': ['cc', 'java', 'go', 'python'],
    'SlhDsaPublicKey': ['cc', 'java', 'go', 'python'],
    ...
    'CompositeMlDsaPrivateKey': ['cc', 'java', 'go'],
    'CompositeMlDsaPublicKey': ['cc', 'java', 'go'],
